...
import { devicePerformance } from '@/data/dashboard/dashboardData';
</script>
<template>
            ...
            <v-table class="month-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-subtitle-1 font-weight-bold">Tên Nhóm</th>
                        <th class="text-subtitle-1 font-weight-bold">Trạng Thái</th>
                        <th class="text-subtitle-1 font-weight-bold text-center">Số lượng</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="item in devicePerformance" :key="item.name" class="month-item">
                        <td>
                        ...
                        <td>
                            <div class="">
                                <h6 class="text-subtitle-1 font-weight-bold text-center">{{ item.quantity }}</h6>
                            </div>
                        </td>
                        <td>
